...
@sneaky_sip = Bar.create!(name: "Sneaky Sip", price: "€", opening_time: 11, closing_time: 20, address: "R. Gustavo de Matos Sequeira 42A, 1250-120 Lisboa")
...
@boa_vista = Bar.create!(name: "Boa Vista", price: "€", opening_time: 11, closing_time: 20, address: "Rua da Boavista 16, 1200-275 Lisboa")
...
@red_frog = Bar.create!(name: "Red Frog", price: "€", opening_time: 11, closing_time: 20, address: "Praça da Alegria 66b, 1250-004 Lisboa")
...
Favourite.create!(bar:@copacabana,user:@luc)
Favourite.create!(bar:@copacabana,user:@feline)
Favourite.create!(bar:@copacabana,user:@aureo)
Favourite.create!(bar:@copacabana,user:@jonas)
Favourite.create!(bar:@copacabana,user:@jeff)
...
BarSubvibe.create!(bar: @copacabana, subvibe: @DJ_music_boogie)
BarSubvibe.create!(bar: @copacabana, subvibe: @tropical_boogie)
BarSubvibe.create!(bar: @copacabana, subvibe: @tapas_boogie)
BarSubvibe.create!(bar: @copacabana, subvibe: @dancefloor_boogie)
