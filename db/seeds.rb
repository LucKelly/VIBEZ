...
@big_T = Bar.create!(name: "Big T", price: "€€", opening_time: 13, closing_time: 23, address: "Rio dos Anjos 73")
...
@grog_pub_sandwich = Bar.create!(name: "Grog Pub Sandwich", price: "15€", opening_time: 11, closing_time: 20, address: "Bar Av.rio de janeiro")
...
@zeinot_bar = Bar.create!(name: "Zeitrot", price: "€", opening_time: 12, closing_time: 21, address: "R.joao saraiva 13 2")
