...
luc.photo.attach(io: URI.open('https://res.cloudinary.com/duq1bnalm/image/upload/v1717670503/018-man_xqsuie.png'), filename: 'maleglasses.jpg')
...
uni_cocktail = Bar.create!(name: "uni_cocktail", price: "€", opening_time: 11, closing_time: 20, address: "Rua de O Século 204, Lisboa")
