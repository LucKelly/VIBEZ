...
@sneaky_sip = Bar.create!(name: "Sneaky Sip", price: "€", opening_time: 11, closing_time: 23, address: "R. Gustavo de Matos Sequeira 42A, 1250-120 Lisboa")
...
@oasis = Bar.create!(name: "Oasis", price: "€", opening_time: 11, closing_time: 23, address: "R. Nova do Carvalho 48, 1200-372 Lisboa")
...
@copacabana = Bar.create!(name: "Copacabana", price: "€€", opening_time: 12, closing_time: 23, address: "R. da Atalaia 91, 1200-043 Lisboa")
...
@cinco = Bar.create!(name: "Cinco", price: "€", opening_time: 13, closing_time: 23, address: "R. Ruben A. Leitão 17A, 1200-392 Lisboa")
...
@secret_garden = Bar.create!(name: "Secret Garden", price: "€€", opening_time: 11, closing_time: 20, address: "Largo Monte, 1170-253 Lisboa")
...
@park_bar = Bar.create!(name: "Park Rooftop", price: "€", opening_time: 11, closing_time: 20, address: "Calçada do Combro 58, 1200-123 Lisboa")
...
@the_couch = Bar.create!(name: "The Couch", price: "€€€", opening_time: 11, closing_time: 20, address: "R. do Alecrim 21A, 1200-014 Lisboa")
...
@ogilins_irish_pub = Bar.create!(name: "Ogilins Irish Pub", price: "€", opening_time: 11, closing_time: 20, address: "R. dos Remolares 8, 1200-371 Lisboa")
...
@british_bar_lisboa = Bar.create!(name: "British Bar Lisboa", price: "€€", opening_time: 11, closing_time: 20, address: "R. Bernardino Costa 52, 1200-052 Lisboa")
...
@the_queen_ale = Bar.create!(name: "The Queen Ale", price: "€€€", opening_time: 11, closing_time: 20, address: "Largo do Tab. 9, 1150-344 Lisboa")
...
@sky_bar = Bar.create!(name: "Sky Bar", price: "€", opening_time: 11, closing_time: 20, address: "Av. da Liberdade 185, 1269-050 Lisboa")
...
@a_capela = Bar.create!(name: "A Capela", price: "€€", opening_time: 11, closing_time: 20, address: "R. da Atalaia 45, 1200-043 Lisboa")
...
@principe_real = Bar.create!(name: "Principe Real", price: "€", opening_time: 11, closing_time: 20, address: "R. Dom Pedro V 56 J, 1250-094 Lisboa")
...
@pavilhao_chines = Bar.create!(name: "Pavilhao chines", price: "€€", opening_time: 11, closing_time: 20, address: "R. Dom Pedro V 89, 1250-093 Lisboa")
...
@big_T = Bar.create!(name: "Big T", price: "€€", opening_time: 13, closing_time: 23, address: "Rua central da cultura 73")
...
@sailors_bar = Bar.create!(name: "Sailors bar", price: "€", opening_time: 11, closing_time: 24, address: "passeio neptuno 15B")
...
@bar_da_ucs = Bar.create!(name: "Bar da UCS", price: "€", opening_time: 11, closing_time: 23, address: "Av.severiano falcao 2")
...
@cocas_place_bar = Bar.create!(name: "Cocas Place Bar", price: "€€", opening_time: 12, closing_time: 22, address: "R. Manuel Ferreira de andrade 2")
...
@upon_angels_bar = Bar.create!(name: "Upon Angels Bar", price: "€€", opening_time: 14, closing_time: 24, address: "Rua dos Anjos 10")
@upon_angels_bar.photo.attach(io: URI.open('https://res.cloudinary.com/duq1bnalm/image/upload/v1717675247/aleksandr-popov-3-Kh6XSu9XQ-unsplash_trrnfo.jpg'), filename: 'sky_bar.jpg')
@bar_1143 = Bar.create!(name: "Bar 1143", price: "€€", opening_time: 11, closing_time: 24, address: "TV.henrique cardoso 41")
...
@corkies = Bar.create!(name: "Corkies", price: "€€€", opening_time: 14, closing_time: 23, address: "Rua da Bica de Duarte belo SIA")
...
@grog_pub_sandwich = Bar.create!(name: "Grog Pub Sandwich", price: "15€", opening_time: 11, closing_time: 20, address: "R.acacio de paiva 3D")
@grog_pub_sandwich.photo.attach(io: URI.open('https://res.cloudinary.com/duq1bnalm/image/upload/v1717675248/denys-nevozhai-LVuwYF-7POM-unsplash_ff8opv.jpg'), filename: 'lisboario.jpg')
@zeinot_bar = Bar.create!(name: "Zeinot", price: "€", opening_time: 12, closing_time: 21, address: "R.joao saraiva 13 2")
...
@templarios_bar = Bar.create!(name: "Templarios", price: "€€", opening_time: 11, closing_time: 23, address: "R.Flores do Lima 8,")
...
puts 'creating Favourites for users bar'
...
BarSubvibe.create!(bar: @grog_pub_sandwich, subvibe: @tapas_intimate)
BarSubvibe.create!(bar: @grog_pub_sandwich, subvibe: @games_pub)
BarSubvibe.create!(bar: @grog_pub_sandwich, subvibe: @pints_intimate)
...
BarSubvibe.create!(bar: @upon_angels_bar, subvibe: @cocktails_intimate)
BarSubvibe.create!(bar: @upon_angels_bar, subvibe: @seating_pub)
BarSubvibe.create!(bar: @upon_angels_bar, subvibe: @tapas_intimate)
BarSubvibe.create!(bar: @upon_angels_bar, subvibe: @ambient_music_intimate)
